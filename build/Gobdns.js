...
Elm.Gobdns = Elm.Gobdns || {};
Elm.Gobdns.make = function (_elm) {
   "use strict";
   _elm.Gobdns = _elm.Gobdns || {};
   if (_elm.Gobdns.values)
   return _elm.Gobdns.values;
   var _op = {},
   _N = Elm.Native,
   ...
   var failedRemoves = $Native$Ports.portIn("failedRemoves",
   ...
   var failedAdds = $Native$Ports.portIn("failedAdds",
   $Native$Ports.incomingSignal(function (v) {
      return _U.isJSArray(v) ? _L.fromArray(v.map(function (v) {
         return _U.isJSArray(v) ? {ctor: "_Tuple2"
                                  ,_0: typeof v[0] === "string" || typeof v[0] === "object" && v[0] instanceof String ? v[0] : _E.raise("invalid input, expecting JSString but got " + v[0])
   ...
   var completedRemoves = $Native$Ports.portIn("completedRemoves",
   $Native$Ports.incomingSignal(function (v) {
      return _U.isJSArray(v) ? _L.fromArray(v.map(function (v) {
         return _U.isJSArray(v) ? {ctor: "_Tuple2"
                                  ,_0: typeof v[0] === "string" || typeof v[0] === "object" && v[0] instanceof String ? v[0] : _E.raise("invalid input, expecting JSString but got " + v[0])
   ...
   var completedAdds = $Native$Ports.portIn("completedAdds",
   $Native$Ports.incomingSignal(function (v) {
      return _U.isJSArray(v) ? _L.fromArray(v.map(function (v) {
         return _U.isJSArray(v) ? {ctor: "_Tuple2"
                                  ,_0: typeof v[0] === "string" || typeof v[0] === "object" && v[0] instanceof String ? v[0] : _E.raise("invalid input, expecting JSString but got " + v[0])
   ...
   var pendingRemoves = $Native$Ports.portIn("pendingRemoves",
   $Native$Ports.incomingSignal(function (v) {
      return _U.isJSArray(v) ? _L.fromArray(v.map(function (v) {
         return _U.isJSArray(v) ? {ctor: "_Tuple2"
                                  ,_0: typeof v[0] === "string" || typeof v[0] === "object" && v[0] instanceof String ? v[0] : _E.raise("invalid input, expecting JSString but got " + v[0])
   ...
   var pendingAdds = $Native$Ports.portIn("pendingAdds",
   $Native$Ports.incomingSignal(function (v) {
      return _U.isJSArray(v) ? _L.fromArray(v.map(function (v) {
         return _U.isJSArray(v) ? {ctor: "_Tuple2"
                                  ,_0: typeof v[0] === "string" || typeof v[0] === "object" && v[0] instanceof String ? v[0] : _E.raise("invalid input, expecting JSString but got " + v[0])
   ...
   var rulesList = $Native$Ports.portIn("rulesList",
   $Native$Ports.incomingSignal(function (v) {
      return _U.isJSArray(v) ? _L.fromArray(v.map(function (v) {
         return _U.isJSArray(v) ? {ctor: "_Tuple2"
                                  ,_0: typeof v[0] === "string" || typeof v[0] === "object" && v[0] instanceof String ? v[0] : _E.raise("invalid input, expecting JSString but got " + v[0])
   ...
   var deleteRuleInput = $Graphics$Input.input("");
   var emptyRule = function (_v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return _U.eq(_v0._0,
              "") && _U.eq(_v0._1,"");}
         _E.Case($moduleName,
         "on line 118, column 32 to 62");
      }();
   };
   var errorLayout = function (errors) {
      return A2($Html$Tags.div,
      _L.fromArray([$Html$Attributes.$class("errors")]),
      $List.isEmpty(errors) ? _L.fromArray([]) : _L.fromArray([$Html.text("Errors: ")
                                                              ,$Html.text(A2($List.join,
                                                              ", ",
                                                              errors))]));
   };
   var headerLayout = A2($Html$Tags.div,
   _L.fromArray([$Html$Attributes.$class("header rule")]),
   _L.fromArray([A2($Html$Tags.div,
                _L.fromArray([$Html$Attributes.$class("hostname-header hostname")]),
                _L.fromArray([$Html.text("Hostname")]))
                ,A2($Html$Tags.div,
                _L.fromArray([$Html$Attributes.$class("target-header")]),
                _L.fromArray([$Html.text("Target")]))]));
   var diffRules = F2(function (rulesA,
   rulesB) {
      return function () {
         var rulesBSet = $Set.fromList(rulesB);
   ...
   state) {
      return function () {
         ...
         switch (_v4.ctor)
         {case "AddComplete":
            return _U.replace([["currentRules"
                               ,_L.append(state.currentRules,
                               _v4._0)]
                              ,["toAdd"
                               ,A2(diffRules,
                               state.toAdd,
            ...
            return _U.replace([["pendingAdd"
                              ...
                              ,["errors"
                               ,A2($List._op["::"],
                               _L.append("Error Adding: ",
                               $String.show(_v4._0)),
                               state.errors)]],
              state);
            case "AddPending":
            return _U.replace([["pendingAdd"
                               ,_L.append(state.pendingAdd,
                               _v4._0)]],
              state);
            case "AddRule":
            return emptyRule({ctor: "_Tuple2"
                             ,_0: state.tmpHostname
                             ,_1: state.tmpTarget}) ? state : _U.replace([["toAdd"
                                                                          ,A2($List._op["::"],
                                                                          {ctor: "_Tuple2"
                                                                          ,_0: state.tmpHostname
                                                                          ,_1: state.tmpTarget},
            ...
            return _U.replace([["currentRules"
              ...
              state);
            case "RemoveFail":
            return _U.replace([["pendingDelete"
                               ,A2(diffRules,
                               state.pendingDelete,
                               _v4._0)]
                              ,["toDelete"
                              ...
                              ,["errors"
                               ,A2($List._op["::"],
                               _L.append("Error Removing: ",
                               $String.show(_v4._0)),
                               state.errors)]],
              state);
            case "RemovePending":
            return _U.replace([["pendingDelete"
                               ,_L.append(state.toDelete,
                               _v4._0)]],
              state);
            case "RemoveRule":
            return _U.replace([["toDelete"
                               ,A2($List._op["::"],
                               _v4._0,
                               state.toDelete)]],
              state);
            case "SetTmpHostname":
            return _U.replace([["tmpHostname"
                               ,_v4._0]],
              state);
            case "SetTmpTarget":
            return _U.replace([["tmpTarget"
                               ,_v4._0]],
              state);
            case "UpdateField":
            return state;}
         _E.Case($moduleName,
         "between lines 144 and 171");
      }();
   });
   var emptyState = {_: {}
                    ,currentRules: _L.fromArray([])
                    ,errors: _L.fromArray([])
                    ,filtr: $Regex.regex("")
                    ,pendingAdd: _L.fromArray([])
                    ,pendingDelete: _L.fromArray([])
                    ,tmpHostname: ""
                    ,tmpTarget: ""
                    ,toAdd: _L.fromArray([])
                    ,toDelete: _L.fromArray([])};
   var startingState = emptyState;
   var RemoveFail = function (a) {
      return {ctor: "RemoveFail"
             ,_0: a};
   };
   var RemoveComplete = function (a) {
      return {ctor: "RemoveComplete"
             ,_0: a};
   };
   var RemovePending = function (a) {
      return {ctor: "RemovePending"
             ,_0: a};
   };
   var RemoveRule = function (a) {
      return {ctor: "RemoveRule"
             ,_0: a};
   };
   var AddFail = function (a) {
      return {ctor: "AddFail"
             ,_0: a};
   };
   var AddComplete = function (a) {
      return {ctor: "AddComplete"
             ,_0: a};
   };
   var AddPending = function (a) {
      return {ctor: "AddPending"
             ,_0: a};
   };
   var AddRule = {ctor: "AddRule"};
   var SetTmpTarget = function (a) {
      return {ctor: "SetTmpTarget"
             ,_0: a};
   };
   var SetTmpHostname = function (a) {
      return {ctor: "SetTmpHostname"
             ,_0: a};
   };
   var FilterRules = function (a) {
      return {ctor: "FilterRules"
             ,_0: a};
   };
   var ListRules = function (a) {
      return {ctor: "ListRules"
             ,_0: a};
   };
   ...
   var ruleLayout = F2(function (pendingRules,
   _v17) {
      return function () {
         switch (_v17.ctor)
         {case "_Tuple2":
            return function () {
                 var isPending = A2($List.any,
                 F2(function (x,y) {
                    return _U.eq(x,y);
                 })({ctor: "_Tuple2"
                    ,_0: _v17._0
                 ...
                 pendingRules);
                 return A2($Html$Tags.div,
                 _L.fromArray([$Html$Attributes.$class(isPending ? "rule pending" : "rule")]),
                 _L.fromArray([A2($Html$Tags.div,
                              _L.fromArray([$Html$Attributes.$class("hostname")]),
                              _L.fromArray([$Html.text(_v17._0)]))
                              ,A2($Html$Tags.div,
                              _L.fromArray([$Html$Attributes.$class("target")]),
                              _L.fromArray([$Html.text(_v17._1)]))
                              ,A2($Html$Tags.button,
                              _L.fromArray([$Html$Attributes.$class("delete-button")
                                           ,$Html$Attributes.disabled(isPending)
                                           ,A2($Html$Events.onclick,
                                           actions.handle,
                                           $Basics.always(RemoveRule({ctor: "_Tuple2"
                                                                     ,_0: _v17._0
                                                                     ,_1: _v17._1})))]),
                              _L.fromArray([$Html.text("Delete Rule")]))]));
              }();}
         _E.Case($moduleName,
         "between lines 106 and 115");
      }();
   });
   var listRules = F3(function (filtr,
   rules,
   pendingRules) {
      return $Html$Tags.div(_L.fromArray([$Html$Attributes.$class("rules")]))($List.map(ruleLayout(A2($Debug.log,
      "Pending:",
      pendingRules)))(function () {
         var regexFilter = $Regex.contains(filtr);
         return A2($List.filter,
         function (_v21) {
            return function () {
               switch (_v21.ctor)
               {case "_Tuple2":
                  return regexFilter(_v21._0) || regexFilter(_v21._1);}
               _E.Case($moduleName,
               "on line 89, column 45 to 89");
            }();
         },
         rules);
      }()));
      ...
      return function () {
         ...
         {case "_Tuple2":
            return A2($Html.toElement,
              _v25._0,
              _v25._1)(A2($Html$Tags.div,
              _L.fromArray([$Html$Attributes.$class("container")]),
              _L.fromArray([A2($Html$Tags.div,
                           _L.fromArray([$Html$Attributes.$class("gobdns-name")]),
                           _L.fromArray([$Html.text("-==GOB DNS==-")]))
                           ,A2($Html$Tags.div,
                           _L.fromArray([$Html$Attributes.$class("rules-filter")]),
                           _L.fromArray([A2($Html$Tags.input,
                           _L.fromArray([A4($Html.on,
                                        "keyup",
                                        $Html.getValue,
                                        actions.handle,
                                        function (v) {
                                           return FilterRules($Regex.regex(v));
                                        })
                                        ,$Html$Attributes.placeholder("Filter String: ")]),
                           _L.fromArray([]))]))
                           ,errorLayout(s.errors)
                           ,headerLayout
                           ,A2($Html$Tags.div,
                           _L.fromArray([$Html$Attributes.$class("rules-container")]),
                           _L.fromArray([A3(listRules,
                           s.filtr,
                           s.currentRules,
                           s.pendingDelete)]))
                           ,A2($Html$Tags.div,
                           _L.fromArray([$Html$Attributes.$class("add-rules")]),
                           _L.fromArray([A2($Html$Tags.input,
                                        _L.fromArray([$Html$Attributes.$class("hostname-add")
                                                     ,A4($Html.on,
                                                     "keyup",
                                                     $Html.getValue,
                                                     actions.handle,
                                                     ...
                                                     ,$Html$Attributes.value(s.tmpHostname)]),
                                        _L.fromArray([]))
                                        ,A2($Html$Tags.input,
                                        _L.fromArray([$Html$Attributes.$class("target-add")
                                                     ,A4($Html.on,
                                                     "keyup",
                                                     $Html.getValue,
                                                     actions.handle,
                                                     SetTmpTarget)
                                                     ,$Html$Attributes.placeholder("Target")
                                                     ,$Html$Attributes.value(s.tmpTarget)]),
                                        _L.fromArray([]))
                                        ,A2($Html$Tags.button,
                                        _L.fromArray([$Html$Attributes.$class("add-button")
                                                     ,A2($Html$Events.onclick,
                                                     actions.handle,
                                                     function (_v29) {
                                                        return function () {
                                        ...
                                        _L.fromArray([$Html.text("Add Rule")]))]))])));}
         _E.Case($moduleName,
         "between lines 65 and 82");
      }();
   });
   var actionsWithPorts = function (rulesList) {
      return $Signal.merges(_L.fromArray([actions.signal
                                         ,A2($Signal.lift,
                                         ListRules,
                                         rulesList)
                                         ,A2($Signal.lift,
   ...
   step,
   startingState,
   actionsWithPorts(rulesList));
   var main = A3($Signal.lift2,
   scene,
   state,
   $Window.dimensions);
   var deleteRule = $Native$Ports.portOut("deleteRule",
   ...
   state));
   var addRule = $Native$Ports.portOut("addRule",
   $Native$Ports.outgoingSignal(function (v) {
      return _L.toArray(v).map(function (v) {
         return [v._0,v._1];
      });
   ...
   _elm.Gobdns.values = {_op: _op
                        ,State: State
                        ,NoOp: NoOp
                        ,UpdateField: UpdateField
                        ,ListRules: ListRules
                        ,FilterRules: FilterRules
                        ,SetTmpHostname: SetTmpHostname
                        ,SetTmpTarget: SetTmpTarget
                        ,AddRule: AddRule
                        ...
                        ,step: step
                        ,actionsWithPorts: actionsWithPorts
                        ,state: state
